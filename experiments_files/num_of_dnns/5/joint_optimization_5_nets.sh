...
do
	...
	python weight_virtualization.py -mode=e -vnn_name=mnist | tee -a mnist_accuracy_5_nets.txt
	echo "GSC performance"
	python weight_virtualization.py -mode=e -vnn_name=gsc | tee -a gsc_accuracy_5_nets.txt
	echo "GTSRB performance"
	python weight_virtualization.py -mode=e -vnn_name=gtsrb | tee -a gtsrb_accuracy_5_nets.txt
	echo "CIFAR10 performance"
	python weight_virtualization.py -mode=e -vnn_name=cifar10 | tee -a cifar10_accuracy_5_nets.txt
	echo "SVHN performance"
	python weight_virtualization.py -mode=e -vnn_name=svhn | tee -a svhn_accuracy_5_nets.txt
