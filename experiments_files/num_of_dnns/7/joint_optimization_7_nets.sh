...
do
	...
	python weight_virtualization.py -mode=e -vnn_name=mnist | tee -a mnist_accuracy_7_nets.txt
	echo "GSC performance"
	python weight_virtualization.py -mode=e -vnn_name=gsc | tee -a gsc_accuracy_7_nets.txt
	echo "GTSRB performance"
	python weight_virtualization.py -mode=e -vnn_name=gtsrb | tee -a gtsrb_accuracy_7_nets.txt
	echo "CIFAR10 performance"
	python weight_virtualization.py -mode=e -vnn_name=cifar10 | tee -a cifar10_accuracy_7_nets.txt
	echo "SVHN performance"
	python weight_virtualization.py -mode=e -vnn_name=svhn | tee -a svhn_accuracy_7_nets.txt
	echo "US8K performance"
	python weight_virtualization.py -mode=e -vnn_name=us8k | tee -a us8k_accuracy_7_nets.txt
	echo "FMNIST performance"
	python weight_virtualization.py -mode=e -vnn_name=fmnist | tee -a fmnist_accuracy_7_nets.txt
