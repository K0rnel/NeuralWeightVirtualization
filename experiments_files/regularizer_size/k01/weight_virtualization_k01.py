...
class WeightVirtualization:
	...
	def __init__(self, num_of_weight_page=721, weight_per_page=100,
	...
	def train_vnn(self, vnn, iteration):
		with tf.Graph().as_default() as graph:
			with tf.Session(graph=graph) as sess:
				...
				matching_loss = self.get_matching_loss(vnn, sess, lamb=0.1)
	...
	def get_matching_loss(self, vnn, sess, lamb=0.1):
