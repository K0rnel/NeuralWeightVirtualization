...
class WeightVirtualization:
	...
	def __init__(self, num_of_weight_page=6649, weight_per_page=10,
	...
	def plot_vnn_fisher(self, vnn_list=None):
		...
		plt.savefig("plot_vnn_fisher.png")	
		plt.show()
	...
	def plot_vnn_weight(self, vnn_list=None):
		...
		for vnn in vnn_list:
			...
			plt.legend(loc='upper right')
		plt.savefig("plot_vnn_weight.png")
		plt.show()
	...
	def plot_network_fisher(self, vnn_list=None):
		...
		for vnn in vnn_list:
			...
			plt.legend(loc='upper right')
		plt.savefig("plot_network_fisher.png")
		plt.show()
	...
	def plot_network_weight(self, vnn_list=None):
		...
		for vnn in vnn_list:
			...
			plt.legend(loc='upper right')
		plt.savefig("plot_network_weight.png")
		plt.show()
	...
	def plot_network_fisher_histogram(self, vnn):
		...
		plt.savefig("plot_network_fisher_histogram.png")
		plt.show()
	...
	def plot_network_weight_histogram(self, vnn):
		...
		plt.savefig("plot_network_weight_histogram.png")
		plt.show()
